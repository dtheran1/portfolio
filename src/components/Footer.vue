  ...
  <footer class="backdrop-opacity-10 backdrop-invert bg-white/5 py-2 px-10 rounded-full mx-28 ">
    <div class="px-4 py-6 md:flex md:items-center md:justify-between ">
      ...
      <div class="flex mt-4 space-x-6 sm:justify-center md:mt-0">
        ...
        <a href="https://github.com/dtheran1" target="_blank"
        ...
        <a href="https://www.linkedin.com/in/daniel-theran/" class="text-gray-400 hover:text-gray-900 dark:hover:text-white">
          <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            <path fill-rule="evenodd"
